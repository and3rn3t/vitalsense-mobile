#!/usr/bin/env python3
"""
Minimal Starter Project - Creates the absolute minimum working VitalSense project
"""

import os
from pathlib import Path

class MinimalProjectBuilder:
    def __init__(self, project_path):
        self.project_path = Path(project_path)
        self.pbxproj_path = self.project_path / "project.pbxproj"
        
        # Counter for generating sequential IDs
        self.id_counter = 0x4000
    ...
    def create_minimal_project(self):
        """Create a minimal working project with just the essential structure"""
        print("🎯 Creating minimal working VitalSense project...")
        ...
        # Create the minimal project content
...
\trootObject = {project_object_id} /* Project object */;
    ...
    def build_project(self):
        ...
        print("🚀 Starting minimal VitalSense project creation...")
        
        # Generate minimal project content
        project_content = self.create_minimal_project()
        
        # Write project file
        print("💾 Writing minimal project file...")
        with open(self.pbxproj_path, 'w') as f:
            f.write(project_content)
        
        print("✅ Minimal project created successfully!")
        print("📊 Imported only essential files (VitalSenseApp.swift + Assets.xcassets)")
        print("🎯 Zero conflicts - ready to build")
...
def main():
    ...
    builder = MinimalProjectBuilder(project_path)
